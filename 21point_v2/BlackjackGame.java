...
public class BlackjackGame implements Serializable {
    ...
    public void humanHit() {
        if (state != GameState.PLAYING || human.isStanding()) return;
    ...
    public void computerHit() {
        if (state != GameState.PLAYING || computer.isStanding()) return;
     ...
     * 根据流程图：如果玩家爆牌则电脑获胜，玩家停牌后电脑爆牌则玩家获胜，
     * 双方均不爆牌则点数接近21点者胜，点数相同则平局
     */
     ...
     * 
     * @return 当前的游戏状态枚举值（NOT_STARTED, PLAYING, HUMAN_BUST, COMPUTER_BUST, HUMAN_WIN, COMPUTER_WIN, DRAW）
     */
